 ...
 *
 * This is a consumer-owned UX helper: the `@microsoft/vscode-ext-webview`
 * package deliberately leaves context-menu handling out of scope, so it lives
 * in the starter kit rather than the package.
 */
/**
